...
#include <sstream>
#include <sys/stat.h>
const char *PATH = "/home/bokoch/CLionProjects/OC/lab1";
const char *NEW_DIR = "/home/bokoch/CLionProjects/OC/lab1/test";
const char *NEW_FILE = "/home/bokoch/CLionProjects/OC/lab1/test/run";
...
//    Параллельное использование файла с разных каталогов сразу приводит к изменениям в общем
    ...
    int fd;
    link("/home/bokoch/CLionProjects/OC/lab1/undef", "/home/bokoch/CLionProjects/OC/lab1/test/run");
    /*if (fork() == 0) {
        ...
        rmdir(NEW_DIR);
        write(fd, "It's me new file: run\n", 100);
        unlink("/home/bokoch/CLionProjects/OC/lab1/test/run");
        close(fd);
    }*/
